...
var app = (function (fs) {
    ...
    /* src/Preview.svelte generated by Svelte v3.38.2 */
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			body = element("body");
    			div = element("div");
    			if (script0.src !== (script0_src_value = "jquery.js")) attr_dev(script0, "src", script0_src_value);
    			add_location(script0, file$1, 7, 6, 82);
    			add_location(script1, file$1, 8, 6, 122);
    			add_location(head, file$1, 6, 4, 69);
    			attr_dev(div, "id", "includedContent");
    			add_location(div, file$1, 16, 6, 261);
    			add_location(body, file$1, 15, 4, 248);
    			add_location(html, file$1, 5, 2, 58);
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ link: fs.link });
    	return [];
    }
